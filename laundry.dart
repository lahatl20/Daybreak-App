...
class LaundryDisplay extends StatelessWidget {
            ...
            Row(
                children: <Widget>[
                  ...
                  Column(
                      crossAxisAlignment: CrossAxisAlignment.end,
                      children: <Widget>[
                        Text('7:30 AM - 11 AM, ',style: TextStyle( color: Colors.black54)  ), Text('12 PM - 4 PM',style: TextStyle( color: Colors.black54)  )
                      ]),
                ]),
                ...
                children: <Widget>[
                  ...
                  Column(
                      ...
                      children: <Widget>[
                        ...
                        Text('9 AM - 11:30 PM',style: TextStyle( color: Colors.black54)  )
                      ]),
                ]),
...
//===================Salvation army============
            ...
            Text('Salvation Army', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.black54) ),

            Row(
                children: <Widget>[

                  Text('Women clients only.',style: TextStyle( color: Colors.black54)),
                ]),
